...
namespace elite_dangerous_colonise.Controllers
{
    ...
    public class ColonisedSystemNamesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get([FromQuery] string? query)
        {
            ...
            {
                Logger.LogError("Colonised System Names Controller", 0, ex);
            ...
            {
                Logger.LogError("Colonised System Names Controller", 1, ex);
